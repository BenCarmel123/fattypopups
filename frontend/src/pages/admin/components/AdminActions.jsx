...
export default function AdminActions({ handleClick }) {
  ...
  return (
    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, auto)', justifyContent: Config.CENTER, gap: '1rem', marginTop: '1rem', color: Config.WHITE, fontWeight: Config.BOLD, alignItems: Config.CENTER }}>
