...
export function formatEventDescription(event) {
  return (
    <div style={{ textAlign: Config.CENTER }}>
      <h2 style={{ direction: 'ltr', unicodeBidi: 'isolate', textAlign: Config.CENTER, marginBottom: '8px', background: Config.HERO_TEAL_GRADIENT, WebkitBackgroundClip: 'text', backgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>{event.title}</h2>
